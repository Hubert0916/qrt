"""Generate annualized return comparison charts from existing metrics."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--root",
        type=Path,
        default=Path("output/benchmark_split"),
        help="Root directory to scan for metrics.csv if --metrics is not specified.",
    )
