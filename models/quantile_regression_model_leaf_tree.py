# models/quantile_regression_model_leaf_tree.py
...
class QuantileRegressionModelTree:
    """
    ...
    def __init__(
        ...
        self.lower_tree: Optional["QuantileRegressionModelTree"] = None
        self.upper_tree: Optional["QuantileRegressionModelTree"] = None
    ...
    def fit_interval(
        ...
        def new_tree() -> "QuantileRegressionModelTree":
            return QuantileRegressionModelTree(
