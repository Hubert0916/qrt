...
class LeafQuantileRegressionTree:
    """
    ...
    def __init__(
        ...
        self.lower_tree: Optional["LeafQuantileRegressionTree"] = None
        self.upper_tree: Optional["LeafQuantileRegressionTree"] = None
    ...
    def fit_interval(
        ...
        def new_tree() -> "LeafQuantileRegressionTree":
            return LeafQuantileRegressionTree(
